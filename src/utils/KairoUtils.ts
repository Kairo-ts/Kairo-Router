...
export class KairoUtils {
  ...
  public static async getPlayerKairoData(
    playerId: string,
  ): Promise<PlayerKairoDataDTO> {
  ...
  public static async saveToDataVault(
    key: string,
    value: AllowedDynamicValue,
  ): Promise<void> {
  ...
  public static async loadFromDataVault(
    key: string,
  ): Promise<AllowedDynamicValue> {
    const kairoResponse = await KairoUtils.sendKairoCommandAndWaitResponse(
      KAIRO_COMMAND_TARGET_ADDON_IDS.KAIRO_DATAVAULT,
  ...
  public static resolvePendingRequest(
    commandId: string,
    response?: KairoResponse,
  ): void {
